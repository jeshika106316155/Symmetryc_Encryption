class SelfAES:
    ...
    def shift_rows(self, s):
        s[0][0], s[1][0], s[2][0], s[3][0] = s[3][0], s[0][0], s[1][0], s[2][0]
        s[0][1], s[1][1], s[2][1], s[3][1] = s[2][1], s[3][1], s[0][1], s[1][1]
        s[0][2], s[1][2], s[2][2], s[3][2] = s[1][2], s[2][2], s[3][2], s[0][2]

    def inv_shift_rows(self, s):
        s[3][0], s[0][0], s[1][0], s[2][0] = s[0][0], s[1][0], s[2][0], s[3][0]
        s[2][1], s[3][1], s[0][1], s[1][1] = s[0][1], s[1][1], s[2][1], s[3][1]
        s[1][2], s[2][2], s[3][2], s[0][2] = s[0][2], s[1][2], s[2][2], s[3][2]
    ...
    def ecb_decrypt(self, s, key: bytes = b'1234567890123456', round_time: int = 5):
        assert len(key) == 16
        assert len(s) % 16 == 0
    ...
    def cbc_encrypt(self, s, key: bytes = b'1234567890123456', round_time: int = 5, iv: bytes = b'2345678901234561'):
        assert len(key) == 16
        assert len(iv) == 16
        assert len(s) % 16 == 0
        for i in range(round_time):
